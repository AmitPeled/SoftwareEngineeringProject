	...
	public class CostumerDataExecutor
		...
		public List<Map> getPurchasedMaps(String username) throws SQLException {
			// having list of all the purchase cityId that the user bought
					...
					for (int i : cityId) {
						mapsIdList
								.addAll(queryExecutor.selectColumnsByValue("citiesMaps","cityId", i, "mapId"));
					}
		...
		public String getSavedCreditCard(String username) throws SQLException {
			List<List<Object>> list = queryExecutor.selectColumnsByValue("costumerPurchaseDeatils", "username",
					username, "creditCard");
			if (list.isEmpty()) {
				return "";
			}
		...
		public boolean repurchaseMembershipBySavedDetails(String username) throws SQLException {
			...
			//get his details from dataBase -> send it to regular purchase
			
			return false;
		}

		@Override
		public List<File> purchaseMapOneTime(int cityId, PurchaseDetails purchaseDetails, String username) throws SQLException {
		...
		@Override
		public void notifyMapView(int cityId, String username) throws SQLException {
			// TODO Auto-generated method stub
