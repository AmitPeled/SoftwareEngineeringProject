...
public class DatabaseExecutor implements IExecuteQueries {
	 ...
	 @Override
	 public List<List<Object>> betweenDatesAnd2Conditions(String tableName, String columnToSelect, Object Date1,
	 ...
	 @Override
	 public List<List<Object>> betweenDatesAnd3Conditions(String tableName, String columnToSelect, Object Date1,
	           String columnDateCondition, Object Date2, String columnCondition1, String columnCondition2,
	           String columnCondition3, Object conditon1, Object condition2, Object condition3) throws SQLException {
		  String sqlquery = "Select " + columnToSelect + " From " + tableName + " Where " + columnDateCondition
		            + " Between ? " + " And ? " + " And " + columnCondition1 + " = ?" + " And " + columnCondition2
		            + " = ?" + "and " + columnCondition3 + " = ?";
		  PreparedStatement preparedStatement = dbConnection.prepareStatement(sqlquery);
		  preparedStatement.setDate(1, (Date) Date1);
		  preparedStatement.setDate(2, (Date) Date2);
		  preparedStatement.setInt(3, (int) conditon1);
		  preparedStatement.setInt(4, (int) condition2);
		  preparedStatement.setObject(5, condition3);
		  List<List<Object>> fields = new ArrayList<>();
		  synchronized (dbAccess) {
			   fields = toList(preparedStatement.executeQuery());
		  }
	 ...
	 @Override
	 public List<List<Object>> betweenDatesAndCondition(String tableName, String columnToSelect, Object Date1,
	           String columnDateCondition, Object Date2, String columnCondition1, Object conditon1)
	           throws SQLException {
		  String sqlquery = "Select " + columnToSelect + " From " + tableName + " Where " + columnDateCondition
		            + " Between ? " + " And ? " + " And " + columnCondition1 + " = ?";
		  PreparedStatement preparedStatement = dbConnection.prepareStatement(sqlquery);
		  preparedStatement.setDate(1, (Date) Date1);
		  preparedStatement.setDate(2, (Date) Date2);
		  preparedStatement.setObject(3, conditon1);
		  List<List<Object>> fields = new ArrayList<>();
		  synchronized (dbAccess) {
			   fields = toList(preparedStatement.executeQuery());
		  }
