...
public final class Map {
	 ...
	 * @param width The width size of the map in real-world meters
	 * @param height The height size of the map in real-world meters
	 * @param offset The location of the top left pixel of the map compared to the default which is zero (no offset)
	 * @throws IllegalArgumentException Thrown when id, width or height are not positive numbers
	 */
	...
	/**
	 * Map ID getter
	 * @return The unique map ID used to represent it in the Database
	 * and when looking for the image file
	 */
	...
	/**
	 * Map offset getter
	 * @return the coordinates of the top left pixel of the map. By default this
