...
public enum GcmQuery implements Serializable {
	...
	updateCity, changeCityPrices, getPriceSubmissions, approveCityPrice, getPurchaseHistory, getCity, logout, getTour, getCitySubmissions, editUsersWithNewPassword, editUsersWithoutNewPassword
}
